...
# Use probabilities from synthetic dataset as labels instead of existing labels
prob_labels = True
prob_labels_file_train = 'results/swin-blackbox-labels-train.pkl'
...
log_level = 'INFO'
work_dir = f'./work_dirs/swin_tiny_16x3x1_45e_ucf101_videos/'
load_from = f'../../../checkpoints/swin_tiny_patch244_window877_kinetics400_1k.pth'
resume_from = None
workflow = [('train', 1)]
